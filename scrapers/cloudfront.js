...
module.exports.scrape = async function (account, credentialsParams) {
    ...
    const cloudfront = new AWS.CloudFront({ apiVersion: '2020-05-31', region: account.Region, ...credentialsParams });
    const data = {
        type: 'cloudfront', items: [], accountId: account.Id, accountName: account.Name, region: account.Region,
    };
    const params = {};
